...
const InstructionsAvado: NextPage<Props> = ({ copyCodeToClipboard }) => (
  <ol>
    <li>
    ...
    <li>
      Go to DappStore and enter hash into search bar or go{" "}
      <a
...
const InstructionsNPM: NextPage<Props> = ({ copyCodeToClipboard }) => (
  <ol>
    <li>
...
const InstructionsDocker: NextPage<Props> = ({ copyCodeToClipboard }) => (
  <ol>
    <li>
...
export const Instructions: NextPage<InstructionsProps> = ({ setShowMsg, instructionsTarget }) => {
  const showCopyCode = () => {
    setShowMsg(true);
    setTimeout(() => {
      setShowMsg(false);
  ...
  const copyCodeToClipboard = (text: string | Array<string>) => {
